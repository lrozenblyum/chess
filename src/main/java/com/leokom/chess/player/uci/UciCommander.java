...
/**
 * Middle layer component of UCI integration.
 * Name contains 'Commander' to add some similarity to
 * WinboardCommander which is middle-level component
 *
