...
public class CheckTest {
	...
	public void cannotExposeKingToCheck() {
		...
		PositionAsserts.assertAllowedMoves( position, "a2", "a3" ); //cannot move horizontally
	}
	...
	public void cannotExposeKingToOpponentKingAttack() {
		...
		PositionAsserts.assertAllowedMoves( position, "a1", "b1" );
	}
	...
	public void cannotExposeKingToCheckTriangulate() {
		...
		PositionAsserts.assertNoAllowedMoves( position, "a2" );
	}
	...
	public void promotionCannotExposeKingToCheck() {
		...
		PositionAsserts.assertNoAllowedMoves( position, "f2" );
	}
	...
	public void checkEvenIfCannotMove() {
		...
		PositionAsserts.assertAllowedMoves( position, "a3", "c3" ); //cannot move b3 and a file
	}
}
