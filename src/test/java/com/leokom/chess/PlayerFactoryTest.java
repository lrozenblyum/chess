...
public class PlayerFactoryTest {
	...
	public void noSystemPropertiesDefaultPlayerBlack() {
		final Player player = new PlayerFactory().createPlayer( Side.BLACK );
	...
	public void canSelectSimpleEngineForWhite() {
		...
		final Player player = new PlayerFactory().createPlayer( Side.WHITE );
	...
	public void failFastOnUnsupportedEngine() {
		...
		new PlayerFactory().createPlayer( Side.WHITE );
	}
